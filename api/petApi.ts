...
export class PetApi {
     ...
     * @param body 
     */
    public async uploadFile (petId: number, additionalMetadata?: string, body?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApiResponse;  }> {
        ...
        if (additionalMetadata !== undefined) {
            localVarQueryParameters['additionalMetadata'] = ObjectSerializer.serialize(additionalMetadata, "string");
        }
